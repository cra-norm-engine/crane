...
const PERM_LABELS: Record<string, string> = {
  ...
  security_update_read: "View security updates & advisories",
  security_update_write: "Publish security updates & advisories",
  lifecycle_notification_read: "View lifecycle notifications",
  lifecycle_notification_write: "Manage lifecycle notifications",
  vulnerability_report_read: "View vulnerability reports",
  vulnerability_report_write: "Manage vulnerability reports",
  enisa_report_read: "View ENISA reports & incident filings",
  enisa_report_write: "Manage ENISA reports & incident filings",
...
const PERM_HINTS: Record<string, string> = {
  ...
  security_update_write: "Publish and edit security updates, advisories, and CVD policy records",
  vulnerability_report_read: "View CRA Art. 14 vulnerability reports and ENISA SRP data",
  vulnerability_report_write: "Create and edit vulnerability reports including VEX assessments",
  enisa_report_read: "View ENISA SRP filings, incident reports, and Art. 14 submission history",
  enisa_report_write: "Log incidents, manage Art. 14 filings, and record SRP submission milestones",
...
const GROUP_DEFS: Omit<PermGroup, "permissions">[] = [
  ...
  {
    id: "vuln",
    label: "Security Updates & Advisories",
  ...
  },
  {
    ...
    icon: `<svg viewBox="0 0 20 20"><path d="M5 3h10a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zm1 3v1.5h8V6zm0 3v1.5h8V9zm0 3v1.5h5V12z" fill="currentColor"/></svg>`,
    colorClass: "perm-icon-orange",
    keys: ["vulnerability_report_read", "vulnerability_report_write"],
  },
  {
    id: "enisa",
    label: "ENISA & Incident Reports",
    icon: `<svg viewBox="0 0 20 20"><path d="M10 2a8 8 0 1 0 0 16A8 8 0 0 0 10 2zm-1 5h2v4h-2zm0 5h2v2h-2z" fill="currentColor"/></svg>`,
    colorClass: "perm-icon-indigo",
    keys: ["enisa_report_read", "enisa_report_write"],
  },
  {
    id: "lifecycle",
