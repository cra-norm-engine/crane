  ...
  <section class="rg-page">
    ...
    <header class="rg-head card" v-if="releaseDetail">
      ...
      <div id="gate-actions" class="rg-head-actions">
        ...
        <!-- Open the EU Declaration of Conformity (CRA Art. 28) for this release -->
        <AppButton
          v-if="releaseDetail"
          variant="secondary"
...
// Navigate to the EU Declaration of Conformity page for this release.
function viewDeclaration(): void {
  router.push({ name: "release-declaration", params: { releaseId: props.releaseId } });
}
