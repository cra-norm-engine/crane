...
.policy-status-draft    { background: var(--color-surface-raised); border: 1px solid var(--color-border); color: var(--color-text-muted); }
.policy-status-active   { background: #1e3d2a; border: 1px solid #3a7a52; color: #6de98a; }
.policy-status-archived { background: var(--color-surface-raised); border: 1px solid var(--color-border); color: var(--color-text-muted); }
